...
(function ($) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
          '<div class="modal fade" id="' + idCartModal + '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="dialog">' +
        '<div class="modal-dialog" role="document">' +
        '<div class="modal-content">' +
        '<div class="modal-header">' +
          '<h5 class="modal-title"><i class="fas fa-shopping-cart my-cart-icon"></i>&nbsp;My Cart</h5>' +
        ...
        '<button type="button" class="genric-btn danger-border radius" data-dismiss="modal" >Close</button>' +
        '<button type="button" class="genric-btn info radius ' + classCheckoutCart + '">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td title="Remove from Cart" class="text-center" style="width: 30px;"><a href="javascript:void(0);" class="genric-btn danger-border radius ' + classProductRemove + '">X</a></td>' +
          '</tr>'
        );
      });
